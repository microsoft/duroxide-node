...
- **[duroxide-python](https://github.com/microsoft/duroxide-python)** —
  ...
  workflows in **Python**.
- **[duroxide-node](https://github.com/microsoft/duroxide-node)** _(this
  repo)_ — Node.js / TypeScript SDK over the duroxide runtime. Use this
  when you want to author workflows in **JavaScript / TypeScript**.
